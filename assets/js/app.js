    ...
    $profileCard.innerHTML = `
                ...
                ${location ? 
                    ...
                    `<li class="meta-item">
                        ...
                        <span class="meta-text">${location}, US</span>
                    </li>` : ""
                    ...
                    <li class="meta-item">
                        ...
                        <span class="meta-text">codewithtito</span>
                    </li>
                ...
                <ul class="profile-stats">
                    ...
                    <li class="stats-item">
                        <span class="body">142</span> Repos
                    </li>
                ...
                <div class="footer">
                    <p class="copyright">&copy; 2024 codewithtito</p>
                </div>
...
const updateRepository = function (){
    ...
    fetchData(`${repoUrl}?sport=created&per_page=12`, function (data){
...
const $forkePanel = document.querySelector("[data-forked-panel]");

const $forkTabBtn = document.querySelector("[data-froked-tab-btn]");
